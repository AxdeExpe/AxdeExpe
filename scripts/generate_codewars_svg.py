...
svg_content = f'''<svg xmlns="http://www.w3.org/2000/svg" width="500" height="280" viewBox="0 0 500 280">
    ...
    <g font-family="Segoe UI, Arial, sans-serif" font-size="14" fill="#f0f6fc">
        ...
        <text x="180" y="190" font-weight="600" fill="#c4c4c4" font-size="12">6 kyu (201 pts)</text>
        
        <text x="30" y="215">Completed Katas:</text>
        <text x="180" y="215" font-weight="600" fill="#c4c4c4">16</text>
    </g>
    ...
    <g font-family="Segoe UI, Arial, sans-serif" font-size="14" fill="#f0f6fc">
        ...
        <text x="270" y="165">Authored Katas:</text>
        <text x="400" y="165" font-weight="600" fill="#c4c4c4">0</text>
    </g>
    ...
    <rect x="30" y="235" width="88.44000000000001" height="10" fill="#c4c4c4" rx="5" ry="5"/>
